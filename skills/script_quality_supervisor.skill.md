...
### 1. セリフ品質
- 吹き出し数: 1ページ最大3個（主人公1-2個 + 男性0-1個）
- 喘ぎ声のバリエーション: 同じ喘ぎが2シーン以上で使われていないか
- 喘ぎのグラデーション: intensity上昇に伴い喘ぎが段階的に激化しているか
- 男セリフ: 1ページ1個以下（多すぎると不評）
- 不自然な敬語/長文: CG集に不適切な小説的表現がないか
- **身体状況報告セリフ**: speech/thoughtが身体状態の客観報告（「汗すごい」「指先痺れ」「ぐったり」等）になっていないか。感情的反応であるべき
- **moanに非喘ぎテキスト**: moanタイプに「ぼーっと」「ふわふわ」「ごめん」「なにこれ」等の言葉が入っていないか
